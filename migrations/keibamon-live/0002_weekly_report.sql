...
-- { status: "sample" } when the table is absent or empty, and the frontend
-- renders the bundled SAMPLE_ARCHIVE. Apply this migration (wrangler d1 execute)
-- to promote the feature to live data.
--
