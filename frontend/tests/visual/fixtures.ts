...
// not the 8-runner fixture every other baseline uses. Names are SYNTHETIC —
// invented, not real horses — of realistic JA character length, because NAME
// WRAP is the actual layout risk (2-char placeholders would prove nothing) and
// the "NOT a plausible race" label and the data must agree. Opt-in per test
