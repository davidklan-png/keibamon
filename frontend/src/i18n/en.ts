...
export const en = {
  ...
  manual: {
    ...
    raceContext: "Race details",
    chooseRace: "Choose a race",
    raceLocked: "Race locked while editing",
  ...
  // Friend Interactions Phase 2 — Save/Share split + FriendPicker. Copy stays
  // recreational (no profit claims); "lock" is banned by guardrails.test.ts.
  share: {
    share: "Share",
    save: "Save",
    pickerTitle: "Share with friends",
    allFriends: "All my friends",
    selectHint: "Or pick specific friends",
    selected: "{n} selected",
    confirm: "Share",
    cancel: "Cancel",
    empty: "You haven't added any friends yet.",
    addFriend: "Find friends",
    sharedToast: "Shared with {n} friends",
    sharedAllToast: "Shared with all your friends",
    shareFailed: "Couldn't share — try again.",
    shareLater: "Share",
    retract: "Remove from feed",
    retractTitle: "Remove from friends' feeds?",
    retractBody: "Comments will be hidden and you can share it again later. Friends won't be notified.",
    retractCta: "Remove",
    retractedToast: "Removed from feeds",
  ...
  friends: {
    ...
    searchHint: "Find friends by their handle",
    noResults: "No one found",
    inviteTitle: "Your invite link",
    inviteHint: "Share this — friends can add you in one tap.",
    inviteCopy: "Copy link",
    inviteCopied: "Copied",
    inviteNeedHandle: "Set a handle to get your invite link.",
    ...
    friendsEmptyHint: "Find friends by handle or share your invite link.",
    feedEmptyNoFriends: "Add friends to see their shared tickets here.",
    feedEmpty: "No shares yet — share a ticket to start your feed.",
    comments: "Comments",
    ...
    commentTooLong: "Keep it under 500 characters",
    commentFailed: "Couldn't post — try again.",
